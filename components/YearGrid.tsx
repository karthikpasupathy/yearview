...
import { getAllDatesInYear, formatDate, getMonthName } from '@/lib/dateUtils';
        ...
        return (
          <div key={monthIndex} className="bg-white border-b border-neutral-200 flex">
            ...
            <div className="bg-neutral-50 px-3 py-2 border-r border-neutral-200 flex items-center justify-center min-w-[60px]">
              <h3 className="text-xs font-semibold text-neutral-600" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
            ...
            <div className="flex-1 relative">
              {/* Day cells grid */}
              <div className="grid grid-cols-31" style={{ gridTemplateColumns: 'repeat(31, minmax(0, 1fr))', height: `${cellHeight}px` }}>
                ...
                {monthEvents.map((event, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className="absolute h-[18px] rounded-md px-2 py-0.5 text-xs font-semibold pointer-events-auto cursor-pointer hover:opacity-90 transition-opacity truncate flex items-center"
                      style={{
                        left: `${leftPercent}%`,
                        width: `${widthPercent}%`,
                        top: `${20 + (idx * 20)}px`,
